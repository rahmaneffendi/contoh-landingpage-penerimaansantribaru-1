...
- `css/styles.css` - tampilan responsif
- `js/main.js` - navigasi mobile, header sticky, dan form demo
- `assets/` - gambar hero, logo inspiratif, ikon, brosur SVG, dan animasi profil
